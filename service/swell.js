// last compiled: 2014-04-22 21:04:04
...
responders.Application = (function() {

  __extends(Application, swell.Responder);

  function Application(config) {
    this.config = config;
  }

  Application.prototype.index = function(request, callback) {
    console.log('index caled', request.data);
    return callback(null, {
      dope: 'fucck yea bitch!'
    });
  };
