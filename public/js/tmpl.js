...
function anonymous(data_0) {
    ...
    var el46 = document.createTextNode("These lists in the examples are rendered by passing a context to a template rendered with ");
    el45.appendChild(el46);
    var el47 = document.createElement("a");
    el47.href = "https://github.com/linkedin/dustjs/wiki/Dust-Tutorial";
    el47.textContent = "DustJS";
    el45.appendChild(el47);
    var el48 = document.createTextNode(". In our simple first case, that template is ");
    el45.appendChild(el48);
    var el49 = document.createElement("code");
    el49.textContent = "client/dust/examples/list_simple.dust";
    el45.appendChild(el49);
    frag.appendChild(el45);
    var el51 = document.createElement("p");
    el51.textContent = "Here's the dust that makes up our simple example with absolutely no frills:";
    frag.appendChild(el51);
    var el53 = document.createElement("pre");
    var el54 = document.createElement("code");
    el54.textContent = "\n  <ol class=\"swell-list sortable\">\n    {#examples}\n      <li id=\"{attributes._id}\"><span style=\"color:#{attributes.color}\">{attributes.name}</span></li>\n    {:else}\n      <li class=\"empty\">There aren't any examples!</li>\n    {/examples}\n  </ol>\n\n";
...
dom.examples.test = (function anonymous(data_0) {
  var data = data_0;
  var el0 = document.createElement("ul");
  var iterated_1 = data_0["stats"];
  for (var i1 in iterated_1) {
    var data_1 = data = iterated_1[i1];
    var el4 = document.createElement("li");
    el4.textContent = i1+": "+data_1;
    el0.appendChild(el4);
  }
  return el0;
});
